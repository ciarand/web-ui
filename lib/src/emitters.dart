...
class WebComponentEmitter extends RecursiveEmitter {
  ...
  CodePrinter run(ComponentInfo info, PathMapper pathMapper,
    ...
    var classBody = new CodePrinter(1)
        ...
        ..addLine('')
        // TODO(terry): Remove [_css]; after migrate to css in WebComponent.
        ...
        // TODO(terry): Remove  assignment after migrate to css in WebComponent.
        ..addLine('  _css = createCssMapper($cssMapExpression);')
