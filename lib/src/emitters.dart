...
class WebComponentEmitter extends RecursiveEmitter {
  ...
  CodePrinter run(ComponentInfo info, PathMapper pathMapper,
    ...
    var cssMapper = createCssSelectorsDefinition(info, cssPolyfill);
    var classBody = new CodePrinter(1)
        ..add('\n')
        ..addLine('/** Autogenerated from the template. */')
        ..addLine('')
        // TODO(terry): Remove [_css]; time to migrate to css in WebComponent.
        ..addLine('static autogenerated.CssMapper _css;')
        ..addLine('')
        ...
        // TODO(terry): Call only createCssMapper not setting up _css.
        ..addLine('  /** CSS class constants. */')
        ..addLine('  _css = createCssMapper($cssMapper);')
