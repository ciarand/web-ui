...
abstract class WebComponent implements Element {
  ...
  ScopedCssMapper css = new ScopedCssMapper({});


  // TODO(terry): After _css is removed change to a void method.
  ScopedCssMapper createCssMapper(Map cssDefinition) {
    css =  new ScopedCssMapper(cssDefinition);
    return css;
  }
  ...
  // TODO(terry): After _css is removed change to a void method.
  ScopedCssMapper createScopedCssMapper(Map cssMap) {
    css = new ScopedCssMapper(cssMap);
    return css;
  }
